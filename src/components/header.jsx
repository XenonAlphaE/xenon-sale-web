                ...
                <div className="w-100 d-flex flex-column align-items-center justify-content-start text-center  ">
                  ...
                  <div className="swapArea">
                    ...
                    <div className="mt-3 padding-top-20 text-center">
                      ...
                      <p translate="" className="font-18 text-center m-0 mt-2"> <img src="/img/flockers/token.svg" style={{ 'height': '35px' }} />Powered by <a target="_blank" href='https://web3paymentsolutions.io/' className=" "><img src="/img/flockers/W3P_Black.svg" alt="" className="poweredByIcon" /></a></p>
                    </div>
                  </div>
