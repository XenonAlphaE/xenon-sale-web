                            ...
                            <div className="box-wrap">
                                ...
                                <div className="boxCustom">
                                    <div  >
                                        ...
                                        <h2 className="font-30 mt-2 d-flex align-items-start text-white">0<span translate="" className="d-inline-block ms-2 font-12 fw-bold text-white">{sectionText.currentRewardsTitle}</span></h2>
                                    </div>
                                </div>
                                <div className="boxCustom">
                                    <div  >
