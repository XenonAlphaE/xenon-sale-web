                                ...
                                <div className="boxCustom">
                                    <div className="w-100">
                                        ...
                                        <div  >
                                            ...
                                            <h2 className="font-30 mt-2 text-white d-flex align-items-start">5,264,008,620 <span translate="" className="d-inline-block ms-2 font-12 fw-bold">{sectionText.symbol}</span></h2>
                                        </div>
                                    </div>
                                </div>
                                <div className="boxCustom">
                                    <div  >
                                        ...
                                        <h2 className="font-30 mt-2 text-break text-white">205% <sup translate="" className="d-inline-block ms-1 font-12 fw-bold">p/a</sup></h2>
                                    </div>
