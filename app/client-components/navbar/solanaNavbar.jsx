  ...
  return (
    ...
    <div className={styles.navContainer} >
        ...
        <a className={styles.appnavBrand} href='/'>
          ...
          <img src="/img/btchyper/logo.svg" alt="Brand Logo" className={styles.brandLogo} />
        ...
        <div className={styles.appnavRight}>
          ...
          <a href="/"  target='_blank' ><img src='/img/btchyper/twitter.svg' className={styles.appSocialIcon} /></a>
          <a href='/'  target='_blank' ><img src='/img/btchyper/telegram.svg' className={styles.appSocialIcon} /></a>
      ...
      {/* <a onClick={toggleMenu} href={`/${currentLanguage}`}>{sectionText?.home}</a> */}
        ...
        <a onClick={toggleMenu} href={isStakingPage ? `/${currentLanguage}/#about` : "#about"}>{sectionText?.about}</a>          {/* <a href={`/${currentLanguage}`}>{sectionText?.home}</a> */}
        ...
        <a onClick={toggleMenu} href={'/'} >{sectionText?.whitePaper}</a>
