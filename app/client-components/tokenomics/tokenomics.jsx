  ...
  return (
    <section id="tokenomics" className="tokenomics-container">
        <div className="tokenomics-content">
            ...
            <h3 className="tokenomics-heading">{sectionText?.heading1} <span style={{color:"white"}}> {sectionText?.heading2} </span> </h3>
            <div className="tokenomics-details-container">
                <div className="tokenomics-cards">
                    ...
                    <div className="tokenomics-card-item">
                        ...
                        <p className="tokenomics-card-desc">{sectionText?.item1}</p>
                    </div>
                    <div className="tokenomics-card-item">
                        <div className="tokenomics-card-figure">
                            <span> 15% </span>
                        ...
                        <p className="tokenomics-card-desc">{sectionText?.item2}</p>
                    </div>
                    <div className="tokenomics-card-item">
                        <div className="tokenomics-card-figure">
                            <span> 10% </span>
                        ...
                        <p className="tokenomics-card-desc">{sectionText?.item3}</p>
                    </div>
                    <div className="tokenomics-card-item">
                        <div className="tokenomics-card-figure">
                            <span> 10% </span>
                        ...
                        <p className="tokenomics-card-desc">{sectionText?.item4}</p>
                    </div>
                    <div className="tokenomics-card-item">
                        <div className="tokenomics-card-figure">
                            <span> 10% </span>
                        ...
                        <p className="tokenomics-card-desc">{sectionText?.item5}</p>
                    </div>
                    <div className="tokenomics-card-item">
                        <div className="tokenomics-card-figure">
                            <span> 40% </span>
                        ...
                        <p className="tokenomics-card-desc">{sectionText?.item6}</p>
                    </div>
                </div>
                <h2 className="tokenomics-total">{sectionText?.total} <span style={{color:"rgb(255, 199, 0)"}}>21,000,000,000</span></h2>
